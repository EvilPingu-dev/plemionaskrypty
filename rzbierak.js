...
init(){
 ...
 <div style="position:fixed;inset:0;background:rgba(2,6,23,.75);display:flex;align-items:center;justify-content:center;z-index:999999;">
  <div style="width:420px;background:white;border-radius:12px;border:2px solid #2563eb;padding:10px;">
   <h3>Scavenge PRO</h3>
   ...
   <div style="background:#eee;margin-top:5px"><div id="${NS}_bar" style="height:6px;background:#2563eb;width:0"></div></div>
   <div id="${NS}_log"></div>
  </div>
 </div>`;
