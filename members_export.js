...
(async function (TribalWars) {
    ...
    const AllyMembers = {
        ...
        export: async function () {
            ...
            try {
				...
				AllyMembers.show_html_table(table);
    ...
    rows.forEach((line, index) => {
        ...
        cols.forEach(col => {
            ...
            cell.textContent = col.replace(/^"(.*)"$/, '$1');
    ...
    Dialog.show('Hermitowski.Members.TableOutput', container.outerHTML);
}
